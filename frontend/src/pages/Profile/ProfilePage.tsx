    ...
    <div className="profile-page-container">
        ...
        <div className="profile-page-container-content">
            ...
            <div className="profile-page-main-content">
                <div className="profile-page-main-content-positioning-container">
                    ...
                    <Container className="profile-page-content-container" fluid>
                        <Row className="profile-page-content-container-row">
